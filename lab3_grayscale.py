...
def gray_from_bgr(bgr):
    """
    Standard luma-ish conversion used by OpenCV when doing BGR->GRAY:
...
<div class="wrap">
  <header>
    <div>
      <div style="font-size:18px;font-weight:900;">Grayscale Tap Lab</div>
      <div class="meta">
        Tap the video to read grayscale intensity at that pixel. Enter a gray value to preview the colour.<br/>
        Grayscale range: 0 (black) → 255 (white).
      </div>
    </div>
    <div id="status" class="status">Connecting…</div>
  ...
  <div class="main">
    ...
    <div class="panel">
      <div class="card">
        ...
        <div class="bigSub mono" id="tapExtra">RGB: —   HEX: —</div>
        <div class="tapHint">Tap bright vs shadow areas 👆</div>
        <div class="small">Try tapping a red object and a blue object with similar brightness. They can have different colours but similar gray.</div>
      </div>
      ...
      <div class="card">
        ...
        <div class="swatch" id="swatch"></div>
        <div class="bigSub mono" id="outText">RGB: —   HEX: —</div>
        <div class="small">All channels equal in grayscale: R=G=B=Gray.</div>
      </div>
    </div>
  </div>
</div>
